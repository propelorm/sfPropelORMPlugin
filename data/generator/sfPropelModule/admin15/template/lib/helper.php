...
abstract class Base<?php echo ucfirst($this->getModuleName()) ?>GeneratorHelper extends sfModelGeneratorHelper
{
  ...
  public function linkToMoveUp($object, $params)
  {
    ...
    return '<li class="sf_admin_action_moveup">'.link_to(__($params['label'], array(), 'sf_admin'), '<?php echo $this->params['route_prefix'] ?>/'.$params['action'].'?id='.$object->getId()).'</li>';
  }
  ...
  public function linkToMoveDown($object, $params)
  {
    ...
    return '<li class="sf_admin_action_movedown">'.link_to(__($params['label'], array(), 'sf_admin'), '<?php echo $this->params['route_prefix'] ?>/'.$params['action'].'?id='.$object->getId()).'</li>';
  }
